...
import User1 from "../../assets/Image/BlogPage/review-author-1.jpg";
import User2 from "../../assets/Image/BlogPage/review-author-2.jpg";
import User3 from "../../assets/Image/BlogPage/review-author-3.jpg";
import User4 from "../../assets/Image/BlogPage/review-author-5.jpg";

function UserFeedBack() {
  return (
    <section className="userFeedback_section">
      <Container>
        <Row>
          <Carousel>
            <Carousel.Item>
